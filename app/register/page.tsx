            ...
            <div className="bg-white rounded-[2rem] shadow-2xl overflow-hidden max-w-md w-full border border-[#E5E0D8]">
                ...
                <div className="p-8 md:p-10">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl md:text-3xl font-serif font-bold text-[#2D2D2D] mb-2">Create Account</h1>
                        <p className="text-[#8D8D8D] text-sm md:text-base">Sign up now and start shopping with us</p>
                    </div>
                    ...
                    <div className="mt-8 text-center pt-6 border-t border-[#F0F0E0]">
                        <p className="text-[#5D5D5D] text-sm">
                            ...
                            <Link href="/login" className="text-[#C08C6C] hover:text-[#A06C4C] font-bold transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </div>
