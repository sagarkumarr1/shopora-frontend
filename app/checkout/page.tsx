                                        ...
                                        <div className="bg-[#F9F9F5] p-6 rounded-xl border border-[#E5E0D8] mt-4">
                                            ...
                                            <form onSubmit={handleAddAddress} className="space-y-4">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <input required placeholder="Full Name" value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} className="w-full p-3 rounded-lg border border-[#E5E0D8] focus:border-[#C08C6C] outline-none bg-white" />
                                                    <input required placeholder="Mobile Number" value={formData.mobile} onChange={e => setFormData({ ...formData, mobile: e.target.value })} className="w-full p-3 rounded-lg border border-[#E5E0D8] focus:border-[#C08C6C] outline-none bg-white" />
                                                </div>
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <input required placeholder="Pincode" value={formData.pincode} onChange={e => setFormData({ ...formData, pincode: e.target.value })} className="w-full p-3 rounded-lg border border-[#E5E0D8] focus:border-[#C08C6C] outline-none bg-white" />
                                                    <input required placeholder="Locality" value={formData.locality} onChange={e => setFormData({ ...formData, locality: e.target.value })} className="w-full p-3 rounded-lg border border-[#E5E0D8] focus:border-[#C08C6C] outline-none bg-white" />
                                                </div>
                                                <textarea required placeholder="Address (Area and Street)" value={formData.address} onChange={e => setFormData({ ...formData, address: e.target.value })} className="w-full p-3 rounded-lg border border-[#E5E0D8] focus:border-[#C08C6C] outline-none bg-white h-24"></textarea>
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <input required placeholder="City/District/Town" value={formData.city} onChange={e => setFormData({ ...formData, city: e.target.value })} className="w-full p-3 rounded-lg border border-[#E5E0D8] focus:border-[#C08C6C] outline-none bg-white" />
                                                    <input required placeholder="State" value={formData.state} onChange={e => setFormData({ ...formData, state: e.target.value })} className="w-full p-3 rounded-lg border border-[#E5E0D8] focus:border-[#C08C6C] outline-none bg-white" />
                                                </div>
