...
import { FaSpinner, FaArrowLeft, FaShoppingCart, FaTimes, FaCheckCircle } from 'react-icons/fa';
...
function OrderSuccessContent() {
    ...
    return (
        <div className="relative flex flex-col items-center w-full max-w-lg mx-auto md:max-w-2xl md:bg-white md:rounded-[2.5rem] md:shadow-2xl md:shadow-[#C08C6C]/10 md:border md:border-[#E5E0D8] transition-all duration-300 overflow-hidden">

            {/* Modal-like Header */}
            <div className="w-full bg-[#F5F9F6] p-4 flex items-center justify-between border-b border-[#E5E0D8] md:rounded-t-[2.5rem]">
                <div className="flex items-center gap-2 text-green-600 font-bold">
                    <FaCheckCircle />
                    <span>Order Placed Successfully!</span>
                </div>
                <Link href="/" className="text-[#8D8D8D] hover:text-[#2D2D2D] p-1 transition-colors">
                    <FaTimes title="Close" />
                </Link>
            </div>
